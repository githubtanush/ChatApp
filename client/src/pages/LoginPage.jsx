...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blue-2xl bg-[url("/bgImage.svg")]'>
      {/* ------ left ------ */}
